...
import { NumberFormat, RenamingRule, SortOrder } from '../types';
import { ArrowUpDown, Calendar, Settings } from './IconComponents';
...
export const Toolbar: React.FC<ToolbarProps> = ({ rule, setRule, fileCount, sortOrder }) => {
  const handleChange = (key: keyof RenamingRule, value: string | number) => {
      ...
      <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => handleChange('startNumber', parseInt(e.target.value, 10) || 0)}
            ...
            <p className="text-xs text-slate-500 mt-1">按时间排序后，重新生成连续编号 (1, 2, 3...)</p>
          </div>
        ) : (
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => handleChange('offsetValue', parseInt(e.target.value, 10) || 0)}
        ...
        <div>
          ...
          >
            ...
            <option value={NumberFormat.Custom}>自定义前缀</option>
          </select>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              onChange={(e) => handleChange('minDigits', parseInt(e.target.value, 10))}
